                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () => navigateToNextScreen(context, Question9()),
                        child: Text14(
                          text: 'Skip',
                      ...
                      child: Column(
                        children: [
                          SizedBox(height: 20
                            ..h),
                          Text24(
                            text: 'Have you used birth control in the last 6 months?',
                            color: Theme.of(context).primaryColor,
                          ),
                          SizedBox(height: 40
                            ..h),
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: SubText(
                                fontSize: 18,
                                text: 'I\'m still using birth control',
                                color: currentIndex == 2
                                    ? AppColor.white
                                    : AppColor.black,
                              ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Future.delayed(Duration(seconds: 1), () {
                        navigateToNextScreen(context, Question9());
                      });
                    },
                    child: Center(
