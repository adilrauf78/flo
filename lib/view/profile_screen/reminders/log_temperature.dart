...
class LogTemperature extends StatefulWidget {
  const LogTemperature({super.key});

  @override
  State<LogTemperature> createState() => _LogTemperatureState();
}

class _LogTemperatureState extends State<LogTemperature> {
  bool periodStart = true;
  bool _isTextChanged = false;
  final TextEditingController _controller = TextEditingController();
  String initialText = 'Don\'t forget to log today\'s temperature in the app!';
