...
class PeriodEnd extends StatefulWidget {
  const PeriodEnd({super.key});

  @override
  State<PeriodEnd> createState() => _PeriodEndState();
}

class _PeriodEndState extends State<PeriodEnd> {
  bool periodEnd = false;
  bool _isTextChanged = false;
  final TextEditingController _controller = TextEditingController();
  String initialText = 'Don\'t forget to log your period end date in the calendar!';
            ...
            Opacity(
              ...
              child: Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () => periodEnd ? _selectTime(context) : null,
                    child: Container(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextField(
                      ...
                      enabled: periodEnd, // Disable input when toggled off
                      minLines: 1,
                      maxLines: 5,
