...
class LogSleep extends StatefulWidget {
  const LogSleep({super.key});

  @override
  State<LogSleep> createState() => _LogSleepState();
}

class _LogSleepState extends State<LogSleep> {
  bool periodStart = true;
  bool _isTextChanged = false;
  final TextEditingController _controller = TextEditingController();
  String initialText = 'Don\'t forget to log tonight\'s sleep duration!';
